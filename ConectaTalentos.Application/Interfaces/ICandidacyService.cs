...
namespace ConectaTalentos.Application.Interfaces
{
    public interface ICandidacyService
    {
        ...
        Task<ApiResponse<IEnumerable<CandidatesResponseDTO>>> GetCandidaciesByJobId(int id, int userId);
        ...
        Task<ApiResponse<MyCandidacyResponseDTO>> UpdateStatusCandidacys(int id, int userId, UpdatStatusDTO dto);
    }
}
